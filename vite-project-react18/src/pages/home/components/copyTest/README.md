...
### 第一步：导入 Confluence 页面

1. 在 **Confluence URL** 输入框中粘贴页面地址。
2. 点击 **Import**。
3. 导入成功后，页面会显示 Table、Comparison Column 和表格预览。
...
2. 点击 **Select screenshots** 选择一张或多张截图。
3. 确认截图列表后点击 **Validate**。
