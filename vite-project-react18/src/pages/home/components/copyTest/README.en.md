...
### Step 1: Import a Confluence page

1. Paste the page address into **Confluence URL**.
2. Click **Import**.
3. After a successful import, the Table selector, Comparison Column selector, and table preview are displayed.
...
### Step 3: Select a Comparison Column
...
2. Click **Select screenshots** and choose one or more screenshots.
3. Review the list and click **Validate**.
...
## 3. Evidence merging and Screen numbers
...
1. Complete Validate or delete the required images.
2. Hover over **Export**.
3. Click **Confluence**.
