...
export const AGENT_MODEL_PRESETS: AgentModelPreset[] = [
  {
    ...
    label: 'GPT-5.4',
    family: 'reasoning',
    summary: '最新高智能主力模型，适合复杂 agent、编码、规划和多工具任务。',
    contextWindow: 'high-context reasoning',
    defaultOutputCap: 'high output budget',
    notes: ['适合复杂 agent 与高质量推理任务。', '建议保持默认采样，让模型通过推理能力完成稳定输出。'],
    defaults: {
      type: 'reasoning',
      temperature: 1,
      maxTokens: 8192,
  ...
  },
  {
    ...
    label: 'GPT-5.4 mini',
    family: 'reasoning',
    summary: 'GPT-5.4 的轻量版本，适合需要兼顾推理能力、速度和成本的 agent。',
    contextWindow: 'high-context reasoning',
    defaultOutputCap: 'mid-high output budget',
    notes: ['适合作为新一代均衡默认模型。', '适合工具编排、内容生成和中等复杂度分析。'],
    defaults: {
      type: 'reasoning',
      temperature: 1,
      maxTokens: 6144,
  ...
  },
  {
    ...
    label: 'GPT-5.2',
    family: 'reasoning',
    summary: '面向编码和 agentic 任务的高智能模型，适合复杂工作流和长链路执行。',
    contextWindow: 'high-context reasoning',
    defaultOutputCap: 'high output budget',
    notes: ['适合编码、分析和多步骤任务。', '如果希望更快响应，可切换到 mini 系列。'],
    defaults: {
      type: 'reasoning',
      temperature: 1,
      maxTokens: 8192,
  ...
  },
  {
    ...
    family: 'reasoning',
    summary: 'DeepSeek V4 的高能力模型，适合复杂推理、编码、工具调用和长上下文 agent。',
    contextWindow: '1M context',
    defaultOutputCap: 'large output budget',
    notes: ['适合复杂 agent 与高质量推理任务。', '需要在 core 的 .env 中配置 DEEPSEEK_API_KEY。'],
    defaults: {
      type: 'reasoning',
      temperature: 1,
      maxTokens: 8192,
  ...
  },
  {
    ...
    family: 'reasoning',
    summary: 'DeepSeek V4 的高性价比模型，适合常规 agent、快速响应和批量任务。',
    contextWindow: '1M context',
    defaultOutputCap: 'mid-high output budget',
    notes: ['适合作为 DeepSeek 的轻量默认选择。', '需要在 core 的 .env 中配置 DEEPSEEK_API_KEY。'],
    defaults: {
      type: 'reasoning',
      temperature: 1,
      maxTokens: 6144,
